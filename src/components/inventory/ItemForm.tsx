      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Action Buttons - Sticky following scroll */}
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex flex-col gap-3">
                    <SubmitButton 
                      isPending={isPending || isReceiptProcessing || isProductImageProcessing}
                      style={{
                    ...
                    <Button 
                      type="button" 
                      onClick={() => router.back()} 
                      disabled={isPending || isReceiptProcessing || isProductImageProcessing}
                      style={{
